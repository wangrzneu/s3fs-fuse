...
static constexpr char help_string[] =
    ...
    "      - Do not verify the server certificate against trusted CAs.\n"
    "      WARNING: Vulnerable to MITM attacks. For testing only.\n"
    "\n"
    "   ssl_verify_hostname (default=\"1\")\n"
    "      - When 1, verify that the certificate matches the hostname.\n"
    "      - When 0, do not verify certificate hostname matching.\n"
    "      WARNING: Vulnerable to MITM attacks. For testing only.\n"
    "\n"
    ...
    "      option.\n"
    "\n"
    "   storage_metrics (default disabled)\n"
    "      - Enable dynamic storage capacity tracking. When enabled,\n"
    "      s3fs will scan the bucket in the background using\n"
    "      ListObjectsV2 to calculate the actual used storage size.\n"
    "      The result is reflected in the statvfs structure so that\n"
    "      commands like df show real used/available space. Local\n"
    "      incremental bookkeeping tracks write/delete operations\n"
    "      between scans. Requires bucket_size to be set for total\n"
    "      capacity. Before the initial scan completes, df reports\n"
    "      the default static values.\n"
    "\n"
    "   storage_metrics_interval (default 21600)\n"
    "      - Re-scan interval in seconds for storage_metrics.\n"
    "      The minimum value is 60 seconds. Default is 21600 (6 hours).\n"
    "\n"
    ...
    "\n"
    "   insecure_logging - put insecure information to the log\n"
    "        Normally, secure information(such as tokens and credentials) is not\n"
    "        output to logs.\n"
    "        Specifying this option will write these secure information to the log.\n"
    "        Use caution when specifying this option, as sensitive authentication\n"
    "        information will be output to the log.\n"
    "\n"
